    ...
    return (
        <>
            <div className={styles["header"]}>
                ...
                <p>You can look for a movie or TV-show by searching by title of what you are looking for. The information about the movie or show will inform in what countries it is available.</p>
                <p>Or you can look for all the movies or TV-shows that are available in a country. Just select the country you want to check and if you want to see the movies or TV-shows.
                    You will get all the results that are available in that country.</p>
                <p>Also there are options to see what is coming to Netflix and what is going to be deleted from Netflix. So you will be able to see what Tv-shows and movies to look forward to. But also when you need to hurry up finishing what you are watching.</p>
            </div>
